...
plt.plot(N, mc, 'r', linestyle='-', marker='.', label='Pure Monte Carlo (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logAn, 1)
plt.plot(N, an, 'g', linestyle='-', marker='.', label='Antithetic Monte Carlo (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logUn, 1)
plt.plot(N, un, 'b', linestyle='-', marker='.', label='Uniform (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logUnji, 1)
plt.plot(N, unji, 'c', linestyle='-', marker='.', label='Uniform Jitter (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logSt, 1)
plt.plot(N, st, 'm', linestyle='-', marker='.', label='Stratified (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logStan1, 1)
plt.plot(N, stan1,'y', linestyle='-', marker='.', label='Stratified (locally antithetic) (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logStan2, 1)
plt.plot(N, stan2, 'xkcd:sky blue', linestyle='-', marker='.', label='Stratified (globally antithetic) (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logStan3, 1)
plt.plot(N, stan3, 'xkcd:purple', linestyle='-', marker='.', label='Stratified (locally and globally antithetic) (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logHa, 1)
plt.plot(N, ha, 'xkcd:pink', linestyle='-', marker='.', label='Halton (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logHarot, 1)
plt.plot(N, harot, 'xkcd:brown', linestyle='-', marker='.', label='Halton Rotated (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logHaan, 1)
plt.plot(N, haan, 'xkcd:teal', linestyle='-', marker='.', label='Halton Antithetic (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logNr, 1)
plt.plot(N, nr, 'xkcd:orange', linestyle='-', marker='.', label='N-Rooks (approx rate: '+"{:.4f}".format(m)+')')
m, b = np.polyfit(logN, logMj, 1)
plt.plot(N, mj, 'xkcd:light green', linestyle='-', marker='.', label='Multi-Jitter (approx rate: '+"{:.4f}".format(m)+')')
plt.yscale('log')
plt.xscale('log')
...
plt.legend()
plt.savefig('tempConvGraph3.png')
